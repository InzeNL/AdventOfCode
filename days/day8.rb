        ...
        frequencies.each do |frequency|
            ...
            nodes.each.with_index do |node, index|
                ...
                target_nodes.each do |target_node|
                    ...
                    while (left_x >= 0 && left_x < width && left_y >= 0 && left_y < height)
                        antinodes << [left_x, left_y]
                    ...
                    right_x = target_node[0]
                    right_y = target_node[1]

                    while (right_x >= 0 && right_x < width && right_y >= 0 && right_y < height)
                        antinodes << [right_x, right_y]
